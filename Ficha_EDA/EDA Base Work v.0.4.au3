GUICreate("EDA Base Work v.0.35", 360, 120)
Opt("SendKeyDelay",50)
...
$respmButton = GUICtrlCreateButton("0", 335, 5, 15, 30) ;кнопка обнулення лічильник
...
$exitButton = GUICtrlCreateButton("Выход", 270, 85, 80, 30)
...
Case $msg = $respmButton ;кнопка обнулення лічильник
	  $var = 1
	  ControlSetText("EDA Base Work v.0.35", "", 10, ""& $var&"")
